...
1. Click the **New ruleset** and select **New branch ruleset**. Use the following settings:
   ...
   <img width="300" alt="target branch settings" src="https://github.com/nahcnats/skills-test-with-actions/blob/main/.github/images/branch-protection-target-settings.png?raw=true" />

   <img width="300" alt="required status checks" src="https://github.com/nahcnats/skills-test-with-actions/blob/main/.github/images/required-status-checks.png?raw=true" />
...
1. Scroll to the bottom to find failed workflows and the **Merge** button now disabled! Nice! 🥰
   ...
   <img width="500" alt="failed tests and disabled merge button" src="https://github.com/nahcnats/skills-test-with-actions/blob/main/.github/images/failed-tests-disabled-merge.png?raw=true" />
...
1. Click the **Merge** button.
   ...
   <img width="500" alt="image" src="https://github.com/nahcnats/skills-test-with-actions/blob/main/.github/images/merge-button-active.png?raw=true" />
